                    ...
                    children: [
                        ...
                        child: Row(
                          ...
                          children: [
                            InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'LOGGED_IN_PAGE_imageBorder_ON_TAP');
                                logFirebaseEvent(
                              ...
                              child: Container(
                                ...
                                child: Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'LOGGED_IN_CircleImage_t7ybnbde_ON_TAP');
                                      logFirebaseEvent(
                      ...
                      Padding(
                        ...
                        child: FlutterFlowDropDown<String>(
                          ...
                          onChanged: (val) async {
                            ...
                            logFirebaseEvent(
                                'LOGGED_IN_state_ON_FORM_WIDGET_SELECTED');
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'LOGGED_IN_PAGE_CREATE_PROFILE_BTN_ON_TAP');
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'LOGGED_IN_PAGE_LOG_OUT_BTN_ON_TAP');
                            logFirebaseEvent('Button_navigate_to');
