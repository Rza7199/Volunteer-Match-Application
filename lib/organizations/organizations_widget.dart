...
class _OrganizationsWidgetState extends State<OrganizationsWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'Organizations'});
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'ORGANIZATIONS_CREATE_PROFILE_BTN_ON_TAP');
                        logFirebaseEvent('Button_backend_call');

                        await currentUserReference!
                            .update(createUserInfoRecordData(
                          city: _model.emailTextController.text,
                          state: _model.orgStateValue,
                          age: int.tryParse(_model.websiteTextController.text),
                          bio: _model.phoneNumberTextController.text,
                        ));
